            ...
            <tr *ngFor="let ticket of tickets" class="hover:bg-gray-50/50 transition-colors">
              ...
              <td class="px-6 py-5 text-sm text-gray-400 font-medium whitespace-nowrap">
                <div class="flex items-center gap-3">
                  <span>{{ ticket.dateCreation | date:'dd MMM yyyy' }}</span>
                  <button [routerLink]="['/user/tickets', ticket.id]" class="p-2 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors" title="Consulter">
